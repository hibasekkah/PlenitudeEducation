...
const formSchema = z.object({
  raison_sus: z.string().min(2, "La raison est trop court."),
});

export function SusSession() {
    ...
    return (
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                        <FormField control={form.control} name="raison_sus" render={({ field }) => (<FormItem><FormLabel>raison_sus</FormLabel><FormControl><Input placeholder="raison_sus" {...field} /></FormControl><FormMessage /></FormItem>)} />
